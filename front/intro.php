...
<div class="tab rb" style="width:87%;">
    <div style="background:#FFF; width:100%; color:#333; text-align:left">
        <video src="./upload/<?=$movie['trailer'];?>" width="300px" height="250px" controls=""
            style="float:right;"></video>
        <font style="font-size:24px"> <img src="./upload/<?=$movie['poster'];?>" width="200px" height="250px"
            ...
            <p style="margin:3px">影片分級 ： <img src="./icon/03C0<?=$movie['level'];?>.png"
                ...
                <?=$Movie::$level[$movie['level']];?></p>
            <p style="margin:3px">影片片長 ： <?=floor($movie['length']/60);?>小時<?=$movie['length']%60;?>分</p>
