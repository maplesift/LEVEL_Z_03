...
<form action="./api/save_movie.php" method="post" enctype="multipart/form-data">
    ...
    <div style="width:70%;margin:auto;display:flex;">
        ...
        <div style="width:90%;">
            ...
            <div class="form">
                <div>片長:</div>
                <div><input type="number" name="length" value="<?=$row['length'];?>"></div>
            </div>
            <div class="form">
                <div>上映日期:</div>
                <div>
                    <select name="year" id="">
                        <option value="2025" <?=($year==2025)?'seleted':'';?>>2025</option>
                        <option value="2026" <?=($year==2026)?'seleted':'';?>>2026</option>
                    </select>
                    年
    ...
    <div style="width:70%;margin:auto;display:flex;">
        ...
        <div style="width:85%;">
            <textarea name="intro" id="" style="width:97%"><?=$row['intro'];?></textarea>
        </div>
    </div>
    <div class="ct">
